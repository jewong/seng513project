...
redirectTo = function(path){
	if(!this.flash.isEmpty()){
		this.setHeader('Set-Cookie', 'flash=' + JSON.stringify(this.flash))
	}
	this.statusCode = 302;
...
extractFlashFromCookie = function(response){
	...
	if(request.headers.cookie){
		...
		if(flashCookie){
			...
			response.setHeader('Set-Cookie', 'flash=0; Expires=Thu, 01-Jan-1970 00:00:01 GMT')
		}
	}
}
